...
function r7_barra_plugin_settings() {
		...
		register_setting( 'r7-barra-settings-group', 'show_acessibilidade' );
		register_setting( 'r7-barra-settings-group', 'show_r7_play' );
}
...
function r7_barra_plugin_settings_page() {
		...
		$show_r7_play = get_option('show_r7_play')?'checked=checked':'';
		$show_acessibilidade = get_option('show_acessibilidade')?'checked=checked':'';
		...
		<div class="wrap">
				...
				<form method="post" action="options.php">
						...
						<table class="form-table">
								...
								<tr valign="top">
										<th scope="row">Exibir item de acessibilidade</th>
										<td><input type="checkbox" <?php echo $show_acessibilidade;?> name="show_acessibilidade"/></td>
								</tr>
								<tr valign="top">
										<th scope="row">Exibir item R7 Play</th>
										<td><input type="checkbox" <?php echo $show_r7_play;?> name="show_r7_play"/></td>
								</tr>
						</table>
						<?php //submit_button(); ?>
